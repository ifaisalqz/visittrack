    ...
    if ($visitor) {
        if ($op == 'checkin') {
            ...
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Successful Check-in Notice - Visit Track';
            ...
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Successful Check-out Notice - Visit Track';
...
// الـ waiting: approved بدون actual_checkin
...
// الـ active: approved مع actual_checkin بدون actual_checkout
