...
<nav class="p-6 bg-white dark:bg-slate-900 sticky top-0 z-50 flex justify-between items-center px-12 border-b border-slate-100 dark:border-slate-800 shadow-sm">
        ...
        <div class="flex items-center gap-4 md:gap-6">
            ...
            <a href="track.php" class="hidden md:flex items-center bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 px-5 py-2 rounded-xl font-bold text-sm border border-slate-200 dark:border-slate-700 transition-colors">
                Track Status
            </a>
    ...
    <script>
        // Only handles the success popup now
